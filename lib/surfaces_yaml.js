...
SurfacesYaml.Regions = (function() {
  ...
  Regions.prototype.to_string = function() {
    var character, characters, entry, entry_mousedown, entry_mouseup, entry_tooltip, index, region, region_name, setting, str, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4;
    characters = {};
    entry_mouseup = {};
    entry_mousedown = {};
    entry_tooltip = {};
    ...
    for (character in characters) {
      ...
      if (entry_mousedown[character] != null) {
        _ref3 = entry_mousedown[character];
...
SurfacesYaml.to_txt = function(data) {
  var aliases, descript, regions, surfaces, txt;
